...
import 'core/services/tray_notification_service.dart';
...
void main() async {
  ...
  // Создаем сервис уведомлений через трей и устанавливаем его в NotificationService
  TrayNotificationService trayNotificationService = TrayNotificationService(systemTrayService);
  NotificationService.setTrayNotificationService(trayNotificationService);
