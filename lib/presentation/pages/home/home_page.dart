          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    // Переход ко вкладке Серверы (индекс 1)
            ...
            // Горизонтальный слайдер-карусель серверов для быстрого выбора
            FutureBuilder<List<VpnConfig>>(
              ...
              builder: (context, snapshot) {
                ...
                // Упрощенная версия без PageView
                return SizedBox(
                  height: 130, // Фиксированная высота без переполнения
