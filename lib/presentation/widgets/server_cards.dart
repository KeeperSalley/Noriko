  ...
  Widget build(BuildContext context) {
    return BlurredHover(
      hoverColor: widget.isSelected 
        ? (AppGlobals.isConnected 
            ? Colors.green 
            : Theme.of(context).colorScheme.primary)
        : const Color(0xFF2D132D),
      child: GestureDetector(
        onTap: () {
          // При выборе сервера сохраняем его в глобальном состоянии
          AppGlobals.updateSelectedServer(widget.server);
          widget.onTap();
        },
        child: Container(
          width: 140,
